...
- `run-rubric-gate` green at current HEAD before any push; gov-infra never
  retired. (Gov-infra provisioning for this repo is sequenced through the
  namespace govern lifecycle — see the steward's `apply-and-verify-governance`
  skill.)
